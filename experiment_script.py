...
LOG_DIRECTORY = 'experiments/logs/{}(noise_added).txt'.format(ops['problem_type'])
...
######### MAIN CODE #############################################################
for noise_level in [0.05, 0.5, 1.0, 1.5]:
    ...
    ops['attractor_noise_level'] = noise_level
    NOISE_LEVEL = ops['attractor_noise_level']
    ...
    #             saved_att_loss.append(aloss)
        ...
        save_results(ops, saved_train_acc, saved_test_acc, saved_att_loss, saved_entropy_final,
                     N_TRAIN, N_TEST, SEQ_LEN, comment="noise_added_test")
